...
uint8_t * CSXFMap::s_map::read_pnt(vector<vektor> & pnt, const SRecord & desc, uint8_t * buf, const unsigned pnt_num, const unsigned dim, const bool is_float, const bool is_large)
{
...
vektor CSXFMap::s_map::cmp_rectangle(const bool is_min) const
{
    vector<double>
        border_x =
        {
...
vektor CSXFMap::s_map::cmp_frame(const bool is_min) const
{
    vector<uint32_t>
        border_x =
        {
