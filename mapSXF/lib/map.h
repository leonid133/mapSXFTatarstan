...
namespace sxf
{
    ...
    class CObject
    {
        public:
            ...
            void init(const std::vector<vektor> __pnt, const EObjectType __type, const unsigned __id, const unsigned __code, const unsigned __localization, const std::string __label);
    ...
    class CMap
    {
        ...
        std::vector< std::vector<vektor> > cnts;
        unsigned __pnts_num;
        ...
        protected:
            ...
            struct
            {
                ...
                std::vector< std::vector<vektor> > matrix;
            } hm;
        ...
        public:
            ...
            std::vector< std::vector<vektor> > contours(unsigned & pnts_num);
    };
};
