...
void CObject::init(const vector<vektor> __pnts, const EObjectType __type, const unsigned __id, const unsigned __code, const unsigned __localization, const string __label)
{
    id = __id;
    code = __code;
    localization = __localization;
...
vector< vector<vektor> > CMap::contours(unsigned & pnts_num)
{
    pnts_num = __pnts_num;
